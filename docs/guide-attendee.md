...
1. *(Optional)* Install the [Microsoft 365 Agents Toolkit CLI](https://learn.microsoft.com/microsoft-365/agents/agents-toolkit/cli/overview) (`atk`). It is used only by optional [Module 13](./lab-steps/introduction-foundry-agent-service/13-custom-engine-agent); manual Teams app upload does not require it.
